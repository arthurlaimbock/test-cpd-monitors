...
def main():
    ...
    metadata_watsonstudio_cp4d_watsonstudio_job_schedule_last_run_fail="cp4d_watsonstudio_job_schedule_last_run_fail=1,cp4d_watsonstudio_job_schedule_last_start_epoch_time={}"
          ...
          if 'schedule'in job['entity']['job']:
              ...
              if job['entity']['job']['last_run_status']=='Failed':
                 events.append({
                        ...
                        "metadata": metadata_watsonstudio_cp4d_watsonstudio_job_schedule_last_run_fail.format
