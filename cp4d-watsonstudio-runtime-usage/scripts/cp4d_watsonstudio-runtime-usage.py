...
def main():  
    ...
    monitor_type = cp4d_monitor.create_and_validate_type("cp4d_watsonstudio_runtime_usage")
    ...
    metadata_type_watsonstudio_runtime_usage_total_count ='cp4d_watsonstudio_runtime_usage_total_count={}'
    metadata_type_watsonstudio_runtime_usage_cpu='cp4d_watsonstudio_runtime_usage_cpu_limit={},cp4d_watsonstudio_runtime_usage_cpu_requests={},cp4d_watsonstudio_runtime_usage_cpu_utilization={}'
    metadata_type_watsonstudio_runtime_usage_memory='cp4d_watsonstudio_runtime_usage_memory_limit={},cp4d_watsonstudio_runtime_usage_memory_requests={},cp4d_watsonstudio_runtime_usage_memory_utilization={}'
    ...
    for project in projects:
      ...
      if len(pods)>0:
         ...
         for pod in pods:
           ...
           events.append({"monitor_type":monitor_type, 
                          ...
                          "metadata": metadata_type_watsonstudio_runtime_usage_cpu.format(pod_cpu_limits,pod_cpu_requests,pod_cpu_usage), 
                          "severity": "info", 
                          "reference": project['entity']['name']+'_'+pod['metadata']['name']})
           events.append({"monitor_type":monitor_type, 
                          "event_type":event_type_watsonstudio_runtime_usage_memory, 
                          "metadata": metadata_type_watsonstudio_runtime_usage_memory.format(pod_memory_limits,pod_memory_requests,pod_memory_usage), 
                          "severity": "info", 
                          "reference": project['entity']['name']+'_'+pod['metadata']['name']})
      ...
      events.append({"monitor_type":monitor_type, 
                           ...
                           "metadata": metadata_type_watsonstudio_runtime_usage_total_count.format(total_runtime), 
                           "severity": "info", 
                           "reference": project['entity']['name']})
