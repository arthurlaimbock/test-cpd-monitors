# IBM Cloud Pak for Data zen watchdog monitor: Watson Studio Job Schedule Information
...
- [Cloud Pak Deployer](cp4d-watsonstudio-job-schedule-info_cloud-pak-deployer.md) 
- [Manual Deployment using oc commands](cp4d-watsonstudio-job-schedule-info_manual.md)

## Monitor Source

Source folder containing the script can be found  [here (cp4d-watsonstudio-job-schedule-info).](/cp4d-watsonstudio-job-schedule-info) 
